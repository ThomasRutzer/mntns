...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__experiments_listing__ = __webpack_require__(144);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ExperimentsListingComponent", function() { return __WEBPACK_IMPORTED_MODULE_0__experiments_listing__["a"]; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExperimentsListingComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_property_decorator__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_property_decorator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_property_decorator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__router__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store___ = __webpack_require__(18);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ExperimentsListingComponent = /** @class */ (function (_super) {
    __extends(ExperimentsListingComponent, _super);
    function ExperimentsListingComponent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.isStarted = false;
        return _this;
    }
    ExperimentsListingComponent.prototype.beforeCreate = function () {
        this.$store.commit(__WEBPACK_IMPORTED_MODULE_2__store___["b" /* mutationTypes */].EXPAND_BACKGROUND);
        this.$store.commit(__WEBPACK_IMPORTED_MODULE_2__store___["b" /* mutationTypes */].DEACTIVATE_BACKGROUND);
    };
    ExperimentsListingComponent.prototype.beforeDestroy = function () {
        this.$store.commit(__WEBPACK_IMPORTED_MODULE_2__store___["b" /* mutationTypes */].DEACTIVATE_BACKGROUND);
        this.$store.commit(__WEBPACK_IMPORTED_MODULE_2__store___["b" /* mutationTypes */].UNFOCUS_REPO);
    };
    ExperimentsListingComponent.prototype.startExperiment = function () {
        this.isStarted = true;
        this.$store.commit(__WEBPACK_IMPORTED_MODULE_2__store___["b" /* mutationTypes */].ACTIVATE_BACKGROUND);
    };
    ExperimentsListingComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0_vue_property_decorator__["Component"])({
            template: __webpack_require__(145),
        })
    ], ExperimentsListingComponent);
    return ExperimentsListingComponent;
...
module.exports = "<div class=\"experiments-listing\">\r\n    <div class=\"experiments-listing__content\">\r\n        <div v-show=\"!isStarted\">\r\n            <h1 class=\"experiments-listing__title\"\r\n                v-title-animation>\r\n                <i>Mnts</i> is a experiment to visualize my Github account.\r\n            </h1>\r\n\r\n            <span class=\"primary-button margin-top--l revealing-content\"\r\n                  :class=\"{'revealing-content--reveal': titleIn}\"\r\n                  @click=\"startExperiment()\">explore</span>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ })

});
//# sourceMappingURL=3.5a1981ca18daa0fce05e.js.map