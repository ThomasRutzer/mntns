...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "NavbarComponent", function() { return __WEBPACK_IMPORTED_MODULE_0__navbar__["a"]; });
...
var NavbarComponent = /** @class */ (function (_super) {
    ...
    function NavbarComponent() {
        ...
        _this.isHome = false;
        _this.links = [
            new __WEBPACK_IMPORTED_MODULE_1__router___["b" /* RouterLink */]('Home', '/'),
        ];
        return _this;
    }
    ...
    NavbarComponent.prototype.created = function () {
        this.isHome = this.$route.path === '/';
    };
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0_vue_property_decorator__["Watch"])('$route.path'),
